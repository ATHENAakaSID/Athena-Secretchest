...
def calculate_voltage_range_from_excel(
    ...
    return {
        ...
        "start_energy_wh_mid": float(np.median(start_energies)),
        "net_wh": net_wh,
        ...
        "final_voltage_mid": float(np.median(final_voltages)),
    }
...
def build_voltage_time_profile(
    ...
    for _, row in details_df.iterrows():
        ...
        v1 = energy_to_voltage(energy_end, voltages, energies)
...
if __name__ == "__main__":
    ...
    print("\n=== Voltage Calculator with Automatic DirectSun/Umbra Time and Plots ===\n")
    ...
    charge_power_w = get_float_input("Enter charging power in W During Sunlit ONLY, example 28: ")
    discharge_power_w = get_float_input("Enter discharging power in W During Umbra ONLY, example 12: ")
    ...
    try:
        ...
        print("   Shows voltage change from pass 1 end to pass 2 start.")
        print("   Orange = DIRECTSUN charging, Gray = UMBRA discharging.")
        print("2. voltage_vs_wh_path.png")
        print("   Shows full V vs Wh Excel curve and the movement path between the two pass times.")
        print("3. voltage_time_profile.csv")
        print("   Contains the exact voltage and Energy_Wh values at every DirectSun/Umbra segment.")
