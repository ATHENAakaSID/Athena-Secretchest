...
# ============================================================
# INTERACTIVE PLOT HELPERS - DISPLAY ONLY, NO FILE SAVING
# ============================================================
...
def show_interactive_v_vs_ah_plot(capacity_ah_df, model, profile_all_df):
...
def show_interactive_ah_segment_plot(profile_all_df):
    """
...
if __name__ == "__main__":
    print("\n=== Voltage Calculator: Time-Independent Isotonic V vs Ah, Python Plots Only ===\n")
    ...
    # Show interactive plots directly in Python.
    # No PNG files and no HTML files are created.
    show_interactive_v_vs_ah_plot(capacity_ah_df, model, profile_all_df)
    show_interactive_ah_segment_plot(profile_all_df)
